...
public class ExponentialMovingAverage extends TechAnalyzer {

	public ExponentialMovingAverage(TechAnalyzerManager techAnalyzerManager) {
		super(techAnalyzerManager);
	}
	
	@Override
	public String getCacheName(String product) {
		return StringCombineUtil.combine(ExponentialMovingAverage.class.getSimpleName(), product);
	}
	...
	public List<AnalysisResult> customResult(DataSource dataSource, String product, Date from, Date to, String... inputs) throws Exception {
		...
		return AnalystUtils.exponentialMovingAverageByResult(lstResult, days);
	}
