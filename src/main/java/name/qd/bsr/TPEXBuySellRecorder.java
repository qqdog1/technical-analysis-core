...
//		dataSource = DataSourceFactory.getInstance().getDataSource(Exchange.TPEX);
		captchaSolver = new CaptchaSolver();
		dir = "D:/SimpleConnect_Maven/techanalyst/file/TPEX/bsr/" + sdf.format(date) + "/";
	...
	private void initLogger() {
		System.setProperty("log4j.configurationFile", "./config/log4j2_tpex_bsr.xml");
...
//		prepareAllProducts();
	...
	private void startDownload() {
		...
		webDriver.get("http://www.tpex.org.tw/web/stock/aftertrading/broker_trading/brokerBS.php");
		String product = "3092";
...
//		}
	...
	private void downloadCaptcha() throws Exception {
		...
		URL url;
		url = new URL(images.get(0).getAttribute("src"));
