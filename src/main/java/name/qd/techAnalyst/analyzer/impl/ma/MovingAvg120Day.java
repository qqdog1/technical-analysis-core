...
public class MovingAvg120Day implements TechAnalyzer {
	private static Logger logger = LogManager.getLogger(MovingAvg120Day.class);
	@Override
	...
	public String getCacheName(String product) {
		return StringCombineUtil.combine(MovingAvg120Day.class.getSimpleName(), product);
	}
}
