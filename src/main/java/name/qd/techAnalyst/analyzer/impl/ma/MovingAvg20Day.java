...
public class MovingAvg20Day implements TechAnalyzer {
	...
	public List<AnalysisResult> analyze(DataSource dataManager, String product, Date from, Date to) {
		...
		return AnalystUtils.NDaysAvg(lst, 20);
	}
	
	@Override
	public String getCacheName(String product) {
		return StringCombineUtil.combine(MovingAvg20Day.class.getSimpleName(), product);
	}
