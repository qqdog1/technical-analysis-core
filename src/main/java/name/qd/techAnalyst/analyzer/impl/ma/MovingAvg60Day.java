...
public class MovingAvg60Day implements TechAnalyzer {
	private static Logger logger = LogManager.getLogger(MovingAvg60Day.class);
	@Override
	public List<AnalysisResult> analyze(DataManager dataManager, String product, Date from, Date to) {
		...
		return AnalystUtils.NDaysAvg(lst, 60);
	}
	
	@Override
	public String getCacheName(String product) {
		return StringCombineUtil.combine(MovingAvg60Day.class.getSimpleName(), product);
	}
